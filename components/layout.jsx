    ...
    return (
        <ThemeProvider theme={theme}>
            <Head>
                ...
                <div style={{ width: 'calc(100vw - 15px)', minHeight: 800, position: 'absolute', zIndex: -1, overflow: 'hidden' }}>
                            <motion.svg
                                viewBox="0 0 1707 1702"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                transition={{ duration: 0.8}}
                                animate={{ x: getConfig(pathname).x, y: getConfig(pathname).y, scale: getConfig(pathname).scale ?? 1 }}
                                style={svgStyle}
                            >
                                <motion.path
